      ...
      <div className="glass-card document-card">
        <div className="document-content">
          ...
          <div style={{ marginTop: '2rem' }}>
            ...
            <div style={{ padding: '1.5rem', background: 'var(--surface-sunken)', borderRadius: '12px', margin: '2rem 0', fontFamily: 'monospace', textAlign: 'center' }}>
            ...
            <div style={{ background: 'var(--code-bg)', padding: '1rem', borderRadius: '8px', border: '1px solid var(--border-subtle)', marginBottom: '1.5rem', fontFamily: 'monospace' }}>
